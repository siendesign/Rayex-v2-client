        ...
        <CardContent className="space-y-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <p className="text-sm text-gray-700">
              Your access to RayEx has been restricted. This may be due to a violation of our terms of service
          ...
          <div className="space-y-3 pt-4">
            <Button
              className="w-full"
              variant="default"
              onClick={() => window.location.href = "mailto:support@rayex.com?subject=Account Suspension Appeal"}
            >
          ...
          <div className="text-center text-xs text-gray-500 pt-4 border-t">
            ...
            <a href="mailto:support@rayex.com" className="text-blue-600 hover:underline">
              support@rayex.com
            </a>
          </div>
        </CardContent>
